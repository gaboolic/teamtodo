package tk.gbl.util.warp;//package tk.gbl.warp;
//
...
//    XStream xStream = new XStream();
//    xStream.registerConverter(new MapCustomConverter(new DefaultMapper(XmlUtil.class.getClassLoader())));
